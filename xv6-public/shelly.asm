...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 88 12 00 00       	push   $0x1288
     16e:	6a 02                	push   $0x2
...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 a4 12 00 00 	jmp    *0x12a4(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
     ...
     224:	52                   	push   %edx
     225:	52                   	push   %edx
     226:	68 ed 11 00 00       	push   $0x11ed
     22b:	50                   	push   %eax
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     2a8:	68 e6 11 00 00       	push   $0x11e6
     2ad:	e8 ae fe ff ff       	call   160 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     2b5:	68 f5 11 00 00       	push   $0x11f5
     ...
     2d3:	68 fa 11 00 00       	push   $0x11fa
     2d8:	6a 02                	push   $0x2
     2da:	e8 e1 0b 00 00       	call   ec0 <printf>
		}
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     2ea:	68 1a 12 00 00       	push   $0x121a
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2f8:	68 0a 12 00 00       	push   $0x120a
     2fd:	6a 02                	push   $0x2
     2ff:	e8 bc 0b 00 00       	call   ec0 <printf>
      exit();
     ...
     381:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     385:	68 f5 11 00 00       	push   $0x11f5
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4f1:	50                   	push   %eax
     4f2:	68 94 18 00 00       	push   $0x1894
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     545:	50                   	push   %eax
     546:	68 94 18 00 00       	push   $0x1894
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     596:	50                   	push   %eax
     597:	68 8c 18 00 00       	push   $0x188c
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5b5:	50                   	push   %eax
     5b6:	68 94 18 00 00       	push   $0x1894
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     65d:	50                   	push   %eax
     65e:	68 94 18 00 00       	push   $0x1894
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6b3:	68 3c 12 00 00       	push   $0x123c
     6b8:	53                   	push   %ebx
     6b9:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     73e:	68 1f 12 00 00       	push   $0x121f
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     75f:	68 3f 12 00 00       	push   $0x123f
     764:	57                   	push   %edi
     765:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7b6:	68 56 12 00 00       	push   $0x1256
     7bb:	57                   	push   %edi
     7bc:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     802:	68 48 12 00 00       	push   $0x1248
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     84d:	68 41 12 00 00       	push   $0x1241
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     87b:	68 5b 12 00 00       	push   $0x125b
     880:	56                   	push   %esi
     881:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     90b:	68 5d 12 00 00       	push   $0x125d
     910:	56                   	push   %esi
     911:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     921:	68 59 12 00 00       	push   $0x1259
     926:	56                   	push   %esi
     927:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     97f:	68 3f 12 00 00       	push   $0x123f
     984:	56                   	push   %esi
     985:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     9ab:	68 7b 12 00 00       	push   $0x127b
     9b0:	56                   	push   %esi
     9b1:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     9df:	68 5f 12 00 00       	push   $0x125f
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ec:	68 6a 12 00 00       	push   $0x126a
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a19:	ff 24 85 bc 12 00 00 	jmp    *0x12bc(,%eax,4)
     ...
     ac1:	59                   	pop    %ecx
{
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     aff:	52                   	push   %edx
     b00:	50                   	push   %eax
     b01:	68 7d 12 00 00       	push   $0x127d
     b06:	6a 02                	push   $0x2
     b08:	e8 b3 03 00 00       	call   ec0 <printf>
    panic("syntax");
     b0d:	c7 04 24 41 12 00 00 	movl   $0x1241,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e5f:	f7 f6                	div    %esi
     e61:	0f b6 92 dc 12 00 00 	movzbl 0x12dc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fd8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     fdb:	b8 d4 12 00 00       	mov    $0x12d4,%eax
