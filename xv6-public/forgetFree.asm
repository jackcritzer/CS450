...
_forgetFree:     file format elf32-i386
...
main(int argc, char *argv[]){
  ...
  11:	6a 28                	push   $0x28
  13:	e8 f8 05 00 00       	call   610 <malloc>

    if(!ptr) {
  18:	83 c4 10             	add    $0x10,%esp
  1b:	85 c0                	test   %eax,%eax
  1d:	74 15                	je     34 <main+0x34>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 3c 07 00 00 	movzbl 0x73c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 32 07 00 00       	mov    $0x732,%eax
...
free(void *ap)
{
 ...
 581:	a1 d4 09 00 00       	mov    0x9d4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 d4 09 00 00       	mov    %eax,0x9d4
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5fd:	a3 d4 09 00 00       	mov    %eax,0x9d4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	39 05 d4 09 00 00    	cmp    %eax,0x9d4
 ...
 696:	e8 e5 fe ff ff       	call   580 <free>
  return freep;
 69b:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6bf:	89 15 d4 09 00 00    	mov    %edx,0x9d4
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 d4 09 00 00 d8 	movl   $0x9d8,0x9d4
 6dd:	09 00 00 
 6e0:	c7 05 d8 09 00 00 d8 	movl   $0x9d8,0x9d8
 6e7:	09 00 00 
    base.s.size = 0;
 6ea:	b8 d8 09 00 00       	mov    $0x9d8,%eax
 6ef:	c7 05 dc 09 00 00 00 	movl   $0x0,0x9dc
 6f6:	00 00 00 
