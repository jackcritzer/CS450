...
main(int argc, char *argv[]){
  ...
  8d:	51                   	push   %ecx
  8e:	51                   	push   %ecx
  8f:	68 06 08 00 00       	push   $0x806
  94:	6a 01                	push   $0x1
  96:	e8 25 04 00 00       	call   4c0 <printf>
		exit();
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 13 08 00 00       	mov    $0x813,%eax
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 ec 0a 00 00       	mov    %eax,0xaec
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 ec 0a 00 00    	mov    %edx,0xaec
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 7bd:	0a 00 00 
 7c0:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 7cf:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 7d6:	00 00 00 
