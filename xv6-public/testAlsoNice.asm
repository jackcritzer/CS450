...
_testAlsoNice:     file format elf32-i386
...
int main(void) {
   ...
   e:	51                   	push   %ecx
    ...
    if(fork() ==0) {
   f:	e8 16 03 00 00       	call   32a <fork>
  14:	85 c0                	test   %eax,%eax
  16:	75 6b                	jne    83 <main+0x83>
        // child
        alsonice(100);
...
int main(void) {
    ...
    if(fork() ==0) {
        ...
        alsonice(100);
  1d:	6a 64                	push   $0x64
  1f:	e8 ae 03 00 00       	call   3d2 <alsonice>
...
int main(void) {
  ...
  46:	81 fb 90 01 00 00    	cmp    $0x190,%ebx
  ...
  51:	31 db                	xor    %ebx,%ebx
        ...
        alsonice(-100);
  53:	6a 9c                	push   $0xffffff9c
  55:	e8 78 03 00 00       	call   3d2 <alsonice>
  ...
  76:	81 fb 90 01 00 00    	cmp    $0x190,%ebx
  7c:	75 e2                	jne    60 <main+0x60>
    ...
    exit();
  7e:	e8 af 02 00 00       	call   332 <exit>
            printf(1, "*", i);
        }
    }
    else{
  ...
  86:	31 db                	xor    %ebx,%ebx
        ...
        alsonice(10);
  88:	6a 0a                	push   $0xa
  8a:	e8 43 03 00 00       	call   3d2 <alsonice>
  ...
  ae:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
  ...
  b9:	31 db                	xor    %ebx,%ebx
        ...
        alsonice(100);
  bb:	6a 64                	push   $0x64
  bd:	e8 10 03 00 00       	call   3d2 <alsonice>
  ...
  d1:	83 c3 01             	add    $0x1,%ebx
            printf(1, "$", i);
  d4:	6a 01                	push   $0x1
  d6:	e8 b5 03 00 00       	call   490 <printf>
        alsonice(10);
        for(int i = 0; i<200; i++) {
            printf(1, ".", i);
        }
  ...
  de:	81 fb c8 00 00 00    	cmp    $0xc8,%ebx
  e4:	75 e2                	jne    c8 <main+0xc8>
  e6:	eb 96                	jmp    7e <main+0x7e>
  e8:	66 90                	xchg   %ax,%ax
  ea:	66 90                	xchg   %ax,%ax
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 c0 07 00 00 	movzbl 0x7c0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 b6 07 00 00       	mov    $0x7b6,%eax
...
free(void *ap)
{
 ...
 631:	a1 5c 0a 00 00       	mov    0xa5c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 71f:	76 3f                	jbe    760 <malloc+0xa0>
    ...
    if(p == freep)
 721:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 746:	e8 e5 fe ff ff       	call   630 <free>
  return freep;
 74b:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 78d:	0a 00 00 
 790:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 60 0a 00 00       	mov    $0xa60,%eax
 79f:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 7a6:	00 00 00 
