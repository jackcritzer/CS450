...
int main(void) {
  ...
  d1:	83 c3 01             	add    $0x1,%ebx
            printf(1, "$", i);
  d4:	6a 01                	push   $0x1
  d6:	e8 a5 03 00 00       	call   480 <printf>
        alsonice(10);
        for(int i = 0; i<200; i++) {
            printf(1, ".", i);
        }
...
free(void *ap)
{
 ...
 69a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 69d:	a3 4c 0a 00 00       	mov    %eax,0xa4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 70f:	76 3f                	jbe    750 <malloc+0xa0>
    ...
    if(p == freep)
 711:	39 05 4c 0a 00 00    	cmp    %eax,0xa4c
 ...
 736:	e8 e5 fe ff ff       	call   620 <free>
  return freep;
 73b:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 77d:	0a 00 00 
 780:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 50 0a 00 00       	mov    $0xa50,%eax
 78f:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 796:	00 00 00 
