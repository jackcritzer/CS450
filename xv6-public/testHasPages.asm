...
_testHasPages:     file format elf32-i386
...
main(void) {
   ...
   e:	51                   	push   %ecx
    ...
    haspages(getpid());
   f:	e8 0e 03 00 00       	call   322 <getpid>
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	50                   	push   %eax
  18:	e8 2d 03 00 00       	call   34a <haspages>

    int *array = (int *)malloc(sizeof(int) * 100);
  1d:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  24:	e8 07 06 00 00       	call   630 <malloc>
  29:	89 c3                	mov    %eax,%ebx

    haspages(getpid());
  2b:	e8 f2 02 00 00       	call   322 <getpid>
  30:	89 04 24             	mov    %eax,(%esp)
  33:	e8 12 03 00 00       	call   34a <haspages>

    free(array);
  38:	89 1c 24             	mov    %ebx,(%esp)
  3b:	e8 60 05 00 00       	call   5a0 <free>

    sbrk(10000);
  40:	c7 04 24 10 27 00 00 	movl   $0x2710,(%esp)
  47:	e8 de 02 00 00       	call   32a <sbrk>

    haspages(getpid());
  4c:	e8 d1 02 00 00       	call   322 <getpid>
  51:	89 04 24             	mov    %eax,(%esp)
  54:	e8 f1 02 00 00       	call   34a <haspages>
